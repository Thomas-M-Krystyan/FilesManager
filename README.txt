...
- fix Regular Expression not working in space separators corner cases
- adjust UI to create more space on the right
------------------------------------------------------------------------
version 0.2

- rename file using "prepend and append text method"
- fix Regular Expression not working in special characters corner cases
------------------------------------------------------------------------
version 0.1.1

- grid structure for controls
- radio button to recognize renaming strategies
- add postfix in "incremented number method"
------------------------------------------------------------------------
version 0.1

- drag and drop files into the application
- rename files using "incremented number method"
- error handling / popup messages
------------------------------------------------------------------------